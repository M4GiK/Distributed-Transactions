...
/**
 * Interface for WarehouseFinland Data Access Object.
 * 
 * @author m4gik <michal.szczygiel@wp.pl>
 * 
 */
public interface WarehouseFinlandDAO {
     ...
     * @throws Exception
     */
    void persistEmployee(WarehouseFinland warehouseFinland) throws Exception;
}
